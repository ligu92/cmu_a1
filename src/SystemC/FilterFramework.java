...
public class FilterFramework extends Thread
{
	...
	*
	* Arguments:
	* 	List<FilterFramework> - this is a List of  filters that this filter will connect to.
	*
	* Returns: void
	*
	* Exceptions: IOException
	...
	****************************************************************************/
	...
	void Connect(List<FilterFramework> Filters)
	{
		try
		{
			// Connect this filter's input to the upstream pipe's output stream
			for (FilterFramework filter : Filters) {
				PipedInputStream InputReadPort = new PipedInputStream();
				PipedOutputStream OutputReadPort = new PipedOutputStream();
	...
	****************************************************************************/
	...
	{
		FilterFramework InputFilter = InputFilters.get(i);
